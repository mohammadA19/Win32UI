...
public static class Win32
{
	...
	public struct WNDCLASSEXW
	{
		...
		public Module* hInstance;
		public Icon* hIcon;
		public Cursor* hCursor;
		public Brush* hbrBackground;
		public PWSTR lpszMenuName;
		public PWSTR lpszClassName;
		public Icon* hIconSm;
	}

	public function LRESULT WNDPROC(Window* param0, uint32 param1, WPARAM param2, LPARAM param3);

	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern LRESULT CallWindowProcW(WNDPROC lpPrevWndFunc, Window* hWnd, uint32 Msg, WPARAM wParam, LPARAM lParam);

	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern Window* CreateWindowExW(WINDOW_EX_STYLE dwExStyle, PWSTR lpClassName, PWSTR lpWindowName, WINDOW_STYLE dwStyle, int32 X, int32 Y, int32 nWidth, int32 nHeight, Window* hWndParent, Menu* hMenu, Module* hInstance, void* lpParam);

	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern LRESULT DefWindowProcW(Window* hWnd, uint32 Msg, WPARAM wParam, LPARAM lParam);
	...
	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern BOOL GetMessageW(MSG* lpMsg, Window* hWnd, uint32 wMsgFilterMin, uint32 wMsgFilterMax);

	[Import("KERNEL32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern Module* GetModuleHandleW(PWSTR lpModuleName);
	...
	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern Cursor* LoadCursorW(Module* hInstance, PWSTR lpCursorName);

	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern Icon* LoadIconW(Module* hInstance, PWSTR lpIconName);

	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern HANDLE LoadImageW(Module* hInst, PWSTR name, GDI_IMAGE_TYPE type, int32 cx, int32 cy, IMAGE_FLAGS fuLoad);

	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern MESSAGEBOX_RESULT MessageBoxW(Window* hWnd, PWSTR lpText, PWSTR lpCaption, MESSAGEBOX_STYLE uType);

	[Import("USER32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern BOOL PeekMessageW(MSG* lpMsg, Window* hWnd, uint32 wMsgFilterMin, uint32 wMsgFilterMax, PEEK_MESSAGE_REMOVE_TYPE wRemoveMsg);
